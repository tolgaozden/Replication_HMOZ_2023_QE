...
%         
%         
%     aux_matrix=[(sysmat.A-sysmat.C*beta_tt),-(sysmat.C*(dd_tt*sysmat.RHO+ee_tt)+sysmat.D);...
%     zeros(model.numExo,model.numEndo),eye(model.numExo)];
...
%         
%       aux_matrix=[sysmat.A,-(sysmat.C*(dd_tt)+sysmat.D);...
%         zeros(model.numExo,model.numEndo),eye(model.numExo)];
%     
%     
%     gamma1=aux_matrix\[sysmat.B+sysmat.C*beta_tt,zeros(model.numEndo,model.numExo);...
%         zeros(model.numExo,model.numEndo),sysmat.RHO];
%     gamma3=aux_matrix\[zeros(model.numEndo,model.numExo);sysmat.Ft];
%     gamma2=aux_matrix\[sysmat.C*(alpha_tt);zeros(model.numExo,1)];        
%         
...
%     aux_matrix=[sysmat.A,-(sysmat.C*(beta_tt*dd_tt+dd_tt*sysmat.RHO)+sysmat.D);...
%         zeros(model.numExo,model.numEndo),eye(model.numExo)];
%     gamma1=aux_matrix\[sysmat.B+sysmat.C*beta_tt^2,0*(sysmat.C*beta_tt*ee_tt+sysmat.Et);...
%         zeros(model.numExo,model.numEndo),sysmat.RHO];
%     gamma3=aux_matrix\[zeros(model.numEndo,model.numExo);sysmat.Ft];
%     gamma2=aux_matrix\[sysmat.C*(alpha_tt+beta_tt*alpha_tt);zeros(model.numExo,1)];    
% %=========================================================================
...
%====================================
    otherwise
        error('error: specified model.PLM does not exist (yet)');
end
