...
model.PLM='msv,t';%options: 'msv,t','msv,t-1',ar(1),t,rls','ar(1),t,sac','ar(1),t-1,rls','ar(1),t-1,sac','ar(2),t-1,rls'
model.learning=0; %options: 1=adaptive learning invoked, 0=beliefs fixed at initial values 
model.learning_algo='msv'; %options: 'msv','ar(1),rls','ar(1),sac','msv,restricted';
model.initial_beliefs='msv,ree-based';%options: 'msv,ree-based,fixed','ar(1),ree-based,fixed','ar(1),ree-based','ar(1),ble-based','ar(1),ble-based,fixed'
model.PLM_timing='t';%this is repetitive, same info in model.PLM, fix it later
