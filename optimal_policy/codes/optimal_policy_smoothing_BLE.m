...
opt.parameters_path='results/ble_estimation_results.mat';
...
opt.model.initial_beliefs='ar(1),ble-based';%options: 'msv,ree-based,fixed','ar(1),ree-based,fixed','ar(1),ree-based','ar(1),ble-based','ar(1),ble-based,fixed'
