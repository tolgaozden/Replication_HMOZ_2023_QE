...
opt.param_grid2= linspace(0.005,0.95,opt.num_grid1);
% opt.gain=0.02;  
...
opt.model.initial_beliefs='msv,ree-based,fixed';%options: 'msv,ree-based,fixed','ar(1),ree-based,fixed','ar(1),ree-based','ar(1),ble-based','ar(1),ble-based,fixed'
