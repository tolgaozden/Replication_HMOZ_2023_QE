...
if T_flag
    T = SW_Estimation_REE_expData.static_resid_tt(T, y, x, params);
end
residual = zeros(29, 1);
lhs = y(1);
...
residual(4) = lhs - rhs;
lhs = y(7);
rhs = T(17)*(y(7)+y(7)*T(3)*T(11)+1/(T(18)*params(14))*y(5))+y(17);
residual(5) = lhs - rhs;
lhs = y(5);
rhs = y(21)-y(12)-y(15)+y(3)*T(5)/(1-params(4)+T(5))+y(5)*(1-params(4))/(1-params(4)+T(5));
residual(6) = lhs - rhs;
lhs = y(6);
rhs = y(6)*T(19)/(1+T(19))+y(6)*1/(1+T(19))-T(20)*(y(15)+y(12)-y(21));
residual(7) = lhs - rhs;
lhs = y(8);
...
residual(9) = lhs - rhs;
lhs = y(10);
rhs = T(21)*(T(3)*T(11)*y(21)+y(10)*params(19)+y(1)*T(22))+y(19);
residual(10) = lhs - rhs;
lhs = y(11);
rhs = y(11)*T(17)+y(11)*T(23)+y(10)*params(17)/(1+T(3)*T(11))-y(10)*(1+T(3)*T(11)*params(17))/(1+T(3)*T(11))+y(21)*T(23)+T(24)*(y(9)*params(22)+y(6)*1/(1-T(19))-y(6)*T(19)/(1-T(19))-y(11))+y(20);
residual(11) = lhs - rhs;
lhs = y(12);
...
residual(19) = lhs - rhs;
lhs = y(13);
rhs = y(13)*(1-T(14))+y(7)*T(14)+y(17)*params(14)*T(18)*T(14);
residual(20) = lhs - rhs;
lhs = y(21);
rhs = y(10)+x(8);
residual(21) = lhs - rhs;
