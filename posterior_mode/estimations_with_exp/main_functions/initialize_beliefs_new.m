...
% vec_dd=(kron(eye(model.numExo-1),sysmat.A-sysmat.C*beta_tt)-...
%     kron(sysmat.RHO',sysmat.C))\vec(sysmat.D);
% dd_tt=reshape(vec_dd,[model.numEndo,model.numExo-1]);

dd_tt = (sysmat.A - sysmat.C * beta_tt - sysmat.C )  \ sysmat. D ; 
