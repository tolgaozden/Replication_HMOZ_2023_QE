...
load results/var1_estimation_results.mat;
load('inputs/mcmc_summary_all_models.mat');
param_mcmc = mcmc_var1_exp.mcmc_for_simul;
...
save VAR_posteriorDist.mat learning_parameters alpha_all beta_all  S_mcmc param_mcmc  model sysmat;
