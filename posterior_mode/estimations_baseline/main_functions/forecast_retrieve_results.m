...
load('dynare_initial_beliefs/slobodyan_dataset.mat');
  ...
  forecast.numObs=7;
  forecast.first_forecast=167; %index of the first variable to forecast
...
file_name=['auxiliary_forecast_model_sac' num2str(jj) '.mat']
...
save forecast_output_sac.mat S_fore_all obs_fore_all forecast likl_all estim_data_length;
